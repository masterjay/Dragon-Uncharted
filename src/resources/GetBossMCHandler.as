package resources
{
	...
	public class GetBossMCHandler extends Sprite
	{
		public function GetBossMCHandler()
		{
			super();
		}
		...
		[Embed(source="../resources/assets/boss/boss_show.png")]
		public static const TextureShow:Class
		[Embed(source="../resources/assets/boss/boss_show.xml",mimeType="application/octet-stream")]
		...
		[Embed(source="../resources/assets/boss/boss_attack.png")]
		public static const TextureAttack:Class
		[Embed(source="../resources/assets/boss/boss_attack.xml",mimeType="application/octet-stream")]
		...
		[Embed(source="../resources/assets/boss/boss_wait.png")]
		public static const TextureWait:Class
		[Embed(source="../resources/assets/boss/boss_wait.xml",mimeType="application/octet-stream")]
		...
		[Embed(source="../resources/assets/boss/boss_die.png")]
		public static const TextureDie:Class
		[Embed(source="../resources/assets/boss/boss_die.xml",mimeType="application/octet-stream")]
		...
		[Embed(source="../resources/assets/boss/boss_affect.png")]
		public static const TextureAffect:Class
		[Embed(source="../resources/assets/boss/boss_affect.xml",mimeType="application/octet-stream")]
		...
		[Embed(source="../resources/assets/boss/bossAll.png")]
		public static const TextureAAll:Class
		[Embed(source="../resources/assets/boss/bossAll.xml",mimeType="application/octet-stream")]
		...
		private static function fnGetMovieClipTexture(name:String):Texture
		{
			...
			{
				var bitmap:Bitmap = new GetBossMCHandler[name]();
