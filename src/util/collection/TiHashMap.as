...
package util.collection
{
	 ...
	 * @author iiley
	 */	
	public class TiHashMap
	{
		
		private var length:int;
		private var content:Dictionary;
		
		public function TiHashMap(){
			length = 0;
		...
		/**
		 * Returns an Array of the key/value pair in this HashMap.
		 * Each element of this Array is an Object {key: key, value: value}
		 */
		public function pairs(): Array {
			var temp:Array = new Array(length);
			var index:int = 0;
			for(var i:* in content){
				temp[index] = {key: i, value: content[i]};
				index ++;
			}
			return temp;
		}
		 ...
		 */
		public function clone():TiHashMap{
			var temp:TiHashMap = new TiHashMap();
			for(var i:* in content){
